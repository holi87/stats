...
import { MultiplayerGameEditPage } from './pages/MultiplayerGameEditPage';
    ...
    <>
      ...
      <Routes>
        <Route path="/" element={<AppLayout />}>
          ...
          <Route path="admin/data" element={<AdminDataTransferPage />} />
          <Route
          ...
          />
          <Route
            path="admin/multiplayer-games/:code/edit"
            element={<MultiplayerGameEditPage />}
          />
